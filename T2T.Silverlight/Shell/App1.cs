...
namespace T2T
{
    ...
    public partial class App1 : Application
    {
        ...
        public MaterialsContext MaterialsService { get; private set; }
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            //his.InitializeRootVisual();


            // Have to set the root visual to get the out-of-browser host to start processing
            // network requests. We'll add the MainPage as a child to the grid once the
            // sequence of load events has completed.
        ...
        {
            T2T.Controls.BusyIndicator busyIndicator = new T2T.Controls.BusyIndicator();
